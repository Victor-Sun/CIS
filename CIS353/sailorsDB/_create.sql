...
in Ramakrishnan and Gehrke's book. I have added several extensions in
order
...
2/9/2016 oracleIntro.doc Page 8 of 11
-- --------------------------------------------------------------------
...
CONSTRAINT rIC4 FOREIGN KEY (bid) REFERENCES Boats(bid)
 ON DELETE SET NULL
 DEFERRABLE INITIALLY DEFERRED,
-- rIC5: The date for a reservation must be later than the date it is
made on.
...
2/9/2016 oracleIntro.doc Page 9 of 11
...
-- --------------------------------------------------------------------
-- Now, if no violations were detected, COMMIT all the commands in this
file
COMMIT; 
